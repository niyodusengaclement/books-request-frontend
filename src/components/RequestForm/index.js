...
class RequestForm extends Component {
  ...
  render() {
              ...
              <Col md="6">
                <span className="clearfix">
                  ...
                  <p className="text-muted float-left">
                    The due date of the request was {due.enddate}
                  </p>
                </span>
              </Col>
            </Row>
    ...
    return (
      <Row className="justify-content-center">
        <AdultForm payload={this.props.payload} church={this.props.church} books={this.props.books} />
        <YoungForm payload={this.props.payload} church={this.props.church} books={this.props.books} />
        <MissionReport payload={this.props.payload} church={this.props.church} books={this.props.books} />
      </Row>
    );
  }
}
