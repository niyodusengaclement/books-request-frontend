                ...
                <Table responsive hover>
                  <thead>
                    <tr>
                      ...
                      {
                        role === 'admin' || role === 'union' ? null : <th scope="col">Pastor</th>
                      }
                    </tr>
                  </thead>
                  <tbody>
                    {
                      churches.length > 0 ? churches.map((church, i) =>
                        <tr key={i}>
                          <th scope="row">{i+1}</th>
                          ...
                          {
                            role === 'admin' || role === 'union' ? null : <td>{church.pastor_name}</td>
                          }
                          
                        </tr>
                      ) 
                      : <tr><td colSpan={role === 'admin' || role === 'union' ? '5' : '6'}>No records found</td></tr>
            ...
            <Card>
              ...
              <CardBody>
                <Table responsive hover>
                  ...
                  <tbody>
                    {
                      pastors.length > 0 ? pastors.map((pastors, i) =>
                        <tr key={i}>
                          <th scope="row">{i+1}</th>
